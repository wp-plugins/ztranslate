...
function ztranslate_activation_check(){
	if ( is_plugin_active( 'qtranslate/qtranslate.php' ) ) {
		deactivate_plugins(basename(__FILE__)); // Deactivate ourself
		wp_die("Sorry, but you can't run this plugin, please deactivate qTranslate first.");
	}
}
register_activation_hook(__FILE__, 'ztranslate_activation_check'); 
...
define('ZT_INTEGER',	3);
define('ZT_URL',		4);
define('ZT_LANGUAGE',	5);
define('ZT_URL_QUERY',	1);
define('ZT_URL_PATH',	2);
define('ZT_URL_DOMAIN',	3);
define('ZT_STRFTIME_OVERRIDE',	1);
define('ZT_DATE_OVERRIDE',		2);
define('ZT_DATE',				3);
define('ZT_STRFTIME',			4);
...
// ZT_URL_QUERY - query (questionmark)
// ZT_URL_PATH - pre-path
// ZT_URL_DOMAIN - pre-domain
$q_config['url_mode'] = ZT_URL_PATH;
...
$q_config['flag_location'] = 'plugins/ztranslate/flags/';
...
require_once(dirname(__FILE__)."/ztranslate_utils.php");
require_once(dirname(__FILE__)."/ztranslate_core.php");
require_once(dirname(__FILE__)."/ztranslate_widget.php");
require_once(dirname(__FILE__)."/ztranslate_configuration.php");

// set hooks at the end
require_once(dirname(__FILE__)."/ztranslate_hooks.php");
?>
